...
class ProfitLossGroupReportWizard(models.Model):
    ...
    def done(self):
        ...
        tdb = group_map[inc_group_id.id]['debit'] - group_map[inc_group_id.id]['credit']
        tcr = group_map[cor_group_id.id]['credit'] - group_map[cor_group_id.id]['debit']
        #group_map[inc_group_id.id]['debit'] +=tdb
        #group_map[cor_group_id.id]['credit'] +=tcr
